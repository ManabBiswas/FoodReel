      ...
      <div className="max-w-2xl mx-auto py-8 px-4">
        ...
        <ErrorBoundary>
          <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded shadow">
            ...
            <div>
              <label className="block text-sm font-medium mb-1">Tag Partner (optional)</label>
              <input value={partnerId} onChange={e=>setPartnerId(e.target.value)} placeholder="Partner ID or company name" className="w-full px-3 py-2 border rounded" />
            </div>

            <div>
              <label className="block text-sm font-medium mb-1">Tag Food Item (optional)</label>
              <input value={foodId} onChange={e=>setFoodId(e.target.value)} placeholder="Food ID or name" className="w-full px-3 py-2 border rounded" />
            </div>
